 ...
 */
public class XinlidanganVO  implements Serializable {
	...
	public void setXinlidengji(String xinlidengji) {
		this.xinlidengji = xinlidengji;
	}
	
	/**
	 * 获取：心理等级
	 */
	public String getXinlidengji() {
		return xinlidengji;
	}
