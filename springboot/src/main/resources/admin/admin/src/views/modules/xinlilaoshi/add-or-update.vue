	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="擅长领域" prop="shanzhanglingyu">
					<el-select :disabled="ro.shanzhanglingyu" v-model="ruleForm.shanzhanglingyu" placeholder="请选择擅长领域" >
						<el-option
							v-for="(item,index) in shanzhanglingyuOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="擅长领域" prop="shanzhanglingyu">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-if="type!='info'"  label="个人简介" prop="gerenjianjie">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.gerenjianjie" label="个人简介" prop="gerenjianjie">
...
export default {
	...
	this.ruleForm.gerenjianjie = this.ruleForm.gerenjianjie.replace(reg,'../../../springboot/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
