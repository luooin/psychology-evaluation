      ...
      <el-form :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm" class="center-form-pv">
        <el-row :style='{"textAlign":"right","display":"block"}'>
			<div :style='{"margin":"0 20px 0 0","display":"inline-block"}'>
			  <label :style='{"margin":"0 10px 0 0","color":"#000","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">试卷</label>
			...
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","backgroundColor":"#fff","color":"#333","backgroundImage":"url(http://codegen.caihongy.cn/20220727/d7a250a4599f4e7d9b11846454a93c80.png)","outline":"none","borderRadius":"4px","width":"100px","fontSize":"14px","backgroundSize":"100% 100%","lineHeight":"60px","height":"60px"}' round @click="search()">查询</el-button>
		</el-row>
        <el-row :style='{"margin":"20px 0","display":"flex"}'>
          <el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","backgroundColor":"#fff","color":"#333","backgroundImage":"url(http://codegen.caihongy.cn/20220727/d7a250a4599f4e7d9b11846454a93c80.png)","outline":"none","borderRadius":"4px","width":"120px","fontSize":"14px","backgroundSize":"cover","height":"55px"}' type="primary" @click="addOrUpdateHandler()" round>新增</el-button>
          <el-button
		     :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","backgroundColor":"#fff","color":"#333","backgroundImage":"url(http://codegen.caihongy.cn/20220727/d7a250a4599f4e7d9b11846454a93c80.png)","outline":"none","borderRadius":"4px","width":"120px","fontSize":"14px","backgroundSize":"cover","height":"55px"}'
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
                size="small"
				:style='{"border":"0","cursor":"pointer","padding":"0 30px","margin":"0 10px 0 0","backgroundColor":"#fff","color":"#333","backgroundImage":"url(http://codegen.caihongy.cn/20220727/d7a250a4599f4e7d9b11846454a93c80.png)","outline":"none","borderRadius":"4px","width":"auto","fontSize":"14px","backgroundSize":"cover","height":"40px"}'
