	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-if="type!='info'"  label="知识内容" prop="zhishineirong">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.zhishineirong" label="知识内容" prop="zhishineirong">
...
export default {
	...
	this.ruleForm.zhishineirong = this.ruleForm.zhishineirong.replace(reg,'../../../springboot/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
