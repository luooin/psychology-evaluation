	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20220727/404e0e98502c43b39dd6d72f6f8fdb8f.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"70px 20px","margin":"0","borderRadius":"10px","backgroundImage":"url(http://codegen.caihongy.cn/20220727/ef38081d06954a35bda8bd82e2c7d9f1.png)","width":"550px","backgroundSize":"100% 100% ","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"margin":"0 0 30px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"24px","fontWeight":"600","height":"auto"}' class="title">高校心理咨询系统的设计注册</div>
				<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='xinlilaoshi'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">老师账号</div>
					<el-input  v-model="ruleForm.laoshizhanghao"  autocomplete="off" placeholder="老师账号"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='xinlilaoshi'">
				...
				<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='xinlilaoshi'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">老师姓名</div>
				...
				<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='xinlilaoshi'">
                    ...
                    <file-upload
                        ...
                        @change="xinlilaoshitouxiangUploadChange"
                    ></file-upload>
				</el-form-item>
				<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='xinlilaoshi'">
                    ...
                    <el-select v-model="ruleForm.xingbie" placeholder="请选择性别" >
                        <el-option
                            v-for="(item,index) in xinlilaoshixingbieOptions"
                            v-bind:key="index"
                            :label="item"
                            :value="item">
                        </el-option>
				...
				<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='xinlilaoshi'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">擅长领域</div>
                    <el-select v-model="ruleForm.shanzhanglingyu" placeholder="请选择擅长领域" >
                        <el-option
                            v-for="(item,index) in xinlilaoshishanzhanglingyuOptions"
                            v-bind:key="index"
                            :label="item"
                            :value="item">
                        </el-option>
				...
				<el-form-item :style='{"width":"60%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='xuesheng'">
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"20px auto 15px","outline":"none","color":"#333","borderRadius":"0","background":"rgba(255, 217, 176, 1)","display":"block","width":"80%","fontSize":"18px","height":"50px"}' type="button" class="r-btn" @click="login()">注册</button>
				<div :style='{"cursor":"pointer","padding":"0 10%","color":"#333","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"1","fontSize":"12px","textDecoration":"underline"}' class="r-login" @click="close()">已有账号，直接登录</div>
			</el-form>
...
export default {
	...
	mounted(){
        ...
        this.xinlilaoshixingbieOptions = "男,女".split(',')
        this.xinlilaoshishanzhanglingyuOptions = "情感,学习,心理,其他".split(',')
	...
	methods: {
        ...
        xinlilaoshitouxiangUploadChange(fileUrls) {
		...
		login() {
			var url=this.tableName+"/register";
					if((!this.ruleForm.laoshizhanghao) && `xinlilaoshi` == this.tableName){
					...
					if((!this.ruleForm.mima) && `xinlilaoshi` == this.tableName){
					...
					if((this.ruleForm.mima!=this.ruleForm.mima2) && `xinlilaoshi` == this.tableName){
						this.$message.error(`两次密码输入不一致`);
						return
					}
					if((!this.ruleForm.laoshixingming) && `xinlilaoshi` == this.tableName){
            ...
            if(this.ruleForm.touxiang!=null) {
                this.ruleForm.touxiang = this.ruleForm.touxiang.replace(new RegExp(this.$base.url,"g"),"");
					...
					if(`xinlilaoshi` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
...
<style lang="scss" scoped>
	.container {
	  position: relative;
	  background: url(http://codegen.caihongy.cn/20220727/404e0e98502c43b39dd6d72f6f8fdb8f.png);
