	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="咨询时间" prop="zixunshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.zixunshijian" label="咨询时间" prop="zixunshijian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-if="type!='info'"  label="咨询内容" prop="zixunneirong">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.zixunneirong" label="咨询内容" prop="zixunneirong">
...
export default {
	...
	this.ruleForm.zixunneirong = this.ruleForm.zixunneirong.replace(reg,'../../../springboot/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
