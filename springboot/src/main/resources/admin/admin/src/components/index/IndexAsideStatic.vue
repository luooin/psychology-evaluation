<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"#8aa4bd"}' class="el-menu-vertical-demo" default-active="0">
				...
				<!-- <el-menu-item index="0" @click="menuHandler('')">
					<i v-if='false' :style='{"width":"18px","verticalAlign":"middle","margin":"0px 3px 0 0px","fontSize":"18px","color":"inherit","textAlign":"center"}' class="el-icon-menu el-icon-s-home" />
				...
				<el-submenu index="1">
					<template slot="title">
						<i v-if='false' :style='{"width":"18px","verticalAlign":"middle","margin":"0px 3px 0 0px","fontSize":"18px","color":"inherit","textAlign":"center"}' class="el-icon-menu el-icon-user-solid" />
				...
				<el-submenu v-for=" (menu,index) in menuList.backMenu" :key="menu.menu" :index="index+2+''">
					<template slot="title">
						<i v-if='false' :style='{"width":"18px","verticalAlign":"middle","margin":"0px 3px 0 0px","fontSize":"18px","color":"inherit","textAlign":"center"}' class="el-icon-menu" :class="icons[index]" />
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  white-space: nowrap;
				  				  line-height: 75px;
				  				  background-image: url(http://codegen.caihongy.cn/20220727/d7a250a4599f4e7d9b11846454a93c80.png);
				  				  position: relative;
				  				  text-align: center;
				  				  height: 75px;
				  		}
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						...
						color: #fff;
						background-image: url(http://codegen.caihongy.cn/20220727/00ad4ab56cbc4fc2b1b0810cb15cb827.png);
					}
